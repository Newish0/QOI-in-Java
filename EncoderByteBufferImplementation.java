...
public class EncoderByteBufferImplementation {
            ...
            for (int x = 0; x < width; x++) {
                ...
                if (color.equals(prevColor)) {
                    ...
                    if (color.equals(seenPixels[hash])) {
                        ...
                        byte[] diff = colorDiff(color, prevColor); // RGBA difference from the previous pixel. Stored as {Red, Green, Blue, Alpha}
